# Sistema de Diseño: Vital Blood Management (BancoVida)

## Identidad de Marca

- Nombre del Producto: BancoVida
...
- Elementos: Logo de BancoVida, buscador global, notificaciones, ayuda y perfil de usuario.
